...
JSON quiz lab for lists, dictionaries, randomization, scoring, and GitHub-friendly contributions.
...
**Dataset reference:** Synthetic JSON question bank  
...
**Codigo curricular:** P09  
**Disciplina:** Logica e Linguagem de Programacao I  
**Dificuldade:** Introdutorio  
**Referencia de dataset:** Synthetic JSON question bank  
