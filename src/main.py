...
DATA_SAMPLE = ROOT / "data" / "sample" / "questions_sample.json"
...
PROJECT = {
  "code": "P09",
  "slug": "data-science-quiz-lab",
  "title": "Data Science Quiz Lab",
  "discipline": "Logic and Programming Language I",
  "disciplinePt": "Logica e Linguagem de Programacao I",
  "difficulty": "Introductory",
  "difficultyPt": "Introdutorio",
  "kind": "quiz",
  "dataset": "Synthetic JSON question bank",
  "source": "Local synthetic sample",
  "description": "JSON quiz lab for lists, dictionaries, randomization, scoring, and GitHub-friendly contributions.",
  "concepts": [
    "lists",
    "dictionaries",
    "random.shuffle",
